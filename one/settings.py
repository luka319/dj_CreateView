...
SECRET_KEY = 'y&2$32w57vdg-8#&!_u#89s)i&6-83)1zb+a@ncd2sfpdcd*9*'
...
bootstrap
--------- 
Bootstrap is crispy-forms’s default template pack, version 
2 of the popular simple and flexible HTML, CSS, and Javascript for user interfaces from Twitter.
bootstrap3
---------- 
Twitter Bootstrap version 3.
bootstrap4
---------- 
support for Twitter Bootstrap version 4.
uni-form 
--------
Uni-form is a nice looking, well structured, highly customizable, accessible and usable forms.
